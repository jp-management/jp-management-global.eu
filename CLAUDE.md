...
Static marketing + application site at **jp-management-global.eu**. Pulled out of Hostinger Business Web Hosting on 2026-04-30 to run on Netlify (auto-deploy from `main`).
...
`main` -> Netlify -> jp-management-global.eu. No build command. Publish dir: `site/`.
